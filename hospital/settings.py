...
INSTALLED_APPS = [
    ...
    'corsheaders',
    # Local apps
    'hospital.apps.accounts',
    'hospital.apps.doctors',
    'hospital.apps.patients',
    'hospital.apps.appointments',
    'hospital.apps.prescriptions',
    'hospital.apps.billing',
    'hospital.apps.dashboard',
]
